...
class _ChildLandingPageSeMadpakkeState extends State<ChildLandingPageSeMadpakke> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.only(top: 10, left: 20), // Adjust padding to move content up and to the right
        child: Column(
            ...
            children: [
              Flexible(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10), // Round the edges on both sides
              ...
              Flexible(
                ...
                child: Container(
                  height: double.infinity,
                  padding: const EdgeInsets.only(left: 45, right: 8, top: 8, bottom: 8), // Add left padding to move the text to the righ
                  decoration: BoxDecoration(
