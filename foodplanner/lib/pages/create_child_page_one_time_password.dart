...
class _CreateChildPageOneTimePasswordState extends State<CreateChildPageOneTimePassword> {
  ...
  Future<List<SchoolClass>> classesFuture =
      CreateChildPageOneTimePassword.schoolClassService.fetchAllClasses();
